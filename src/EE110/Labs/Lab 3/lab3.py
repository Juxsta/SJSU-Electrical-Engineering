...
plot(y+1, (t,0,5*Tau), title='Step Response High Pass', xlabel='time(s)', ylabel='Step response')
...
Tau=1.0
U= laplace_transform(Heaviside(t), t, s)
print( "The Laplace transform of the unit step function, u(t) is:", U[0],".")
# Use U[0] becaie the result of the laplace_transform function is a tuple.
h=1/Tau*exp(-t/Tau)
print( "The impulse response of a low pass filter with Tau=",Tau," is:", h, ".")
H= laplace_transform(h, t, s)
print( "The Laplace transform of a low pass filter with Tau=",Tau," is:", H, ".")
Y= U[0]*H[0]
print( "The frequency response of a unit step input into a low pass filter with Tau=",Tau," is:", Y,".")
Y_PF=apart(Y)
print( "The partial fraction expansion of the frequency response of a unit step input into a low pass filter with Tau=",Tau," is:", Y_PF,".")
y=inverse_laplace_transform(Y_PF,s,t).evalf().simplify() 
print( "Time domain step reponse of a low pass filter with Tau=",Tau," is:", y,".")
plot(y, (t,0,5*Tau), title='Step Response Low Pass', xlabel='time(s)', ylabel='Step response')
#%% imports
from sympy import *
import sympy as sy
...
plot(y,(t,0,5),title="Rectangular * Triangular", xlabel='time(s)' )
#%% 
Tau=1
x=1/Tau*exp(-t/Tau)
